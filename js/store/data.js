...
export const experienceData = {
  ...
  'evaluate': '兴趣是最好的老师，喜欢前端所思所想即可写成所得，个人自学能力较强，责任感和韧性比较强，毕竟是在项目上线前现场临时改过代码的人。 <br/>喜欢前后端分离，喜欢造轮子，有所学习必有文档产出。 <br/>喜欢折腾和技术分享，，工作上喜欢接受挑战，工作之余喜欢按照规划补充自己的技术栈，也比较喜欢学习的状态，喜欢拥抱开源社区，代码洁癖晚期，对于脏代码容忍度比较低，eslint严重依赖者。<br/>目前用过前端三大框架，几个平台小程序，或者一些跨端框架，都有轻度使用或者有相关学习成品。<br/>软件上方面版本管理的svn和git使用比较熟练，后台主要是对.net比较熟悉，换了多个编辑器，目前比较喜欢用的是vscode。'
};
